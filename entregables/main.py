...
def insertar_cancion():
    ...
    nueva_cancion = consultar_cancion_por_isrc(isrc) # Validamos si ya existe la canción
...
def insertar_relacion_es_guardada_por():
    ...
    usuario = consultar_usuario_por_dni(usuario_dni) # Validamos si ya existe el usuario
    if (usuario != None):
...
def insertar_relacion_es_interpretada_por_es_de():
    ...
    cancion = consultar_cancion_por_isrc(cancion_isrc) # Validamos si ya existe la canción
    if(cancion != None):
...
while (numero != 0):
    ...
    # print("1. Consultar canción por ISRC") # Consulta Tabla1 - Esta consulta se utiliza en algunos apartados
    # print("2. Consultar usuario por DNI")  # Consulta Tabla5 - Esta consulta se utiliza en algunos apartados
